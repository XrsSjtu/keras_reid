...
# from marketdataset import get_img
#
...
from marketdataset import get_triplet_hard_data
...
with open(train_file,"w") as f:
    ...
    #query_feature = normalize(query_feature)
    #top1 = single_query(query_feature, test_feature, query_label, test_label, test_num=1000)
    class_triplet_model.save("/home/xurongsen/soft/keras_reid-master/weight/market/10000_market.h5")
    print("save successfully!")